...
| **E3** | How does one charge know the other is there? | E2 | internal_to_theory | ⚠ **first use of `internal_to_theory`** — the field concept has no honest everyday anchor | 📄 prototype `electric-field` |
